...
"intro-sec5": {
  ...
  cap1: {
    ...
    paragraphs: [
      ...
      "É importante notar que uma proposição **não precisa ser verdadeira** para ser considerada uma proposição. Ela representa apenas uma possibilidade sobre o estado do mundo. Em muitos contextos (especialmente em ciência de dados), lidamos justamente com proposições cuja veracidade ainda não conhecemos, ou que dependem de outras proposições para serem avaliadas. A lógica fornece os instrumentos necessários para lidar com essas dependências de forma rigorosa.",
