            ...
            if (p.trimStart().startsWith("|")) {
              ...
              if (dataLines.length > 0) {
                ...
                if (isSingleCol && rows.length === 0) {
                  ...
                  const isDS = /Ciência de Dados|Conexão com a lógica|A ideia central|Exemplo narrado|Conclusão geral/i.test(content);
                ...
                if (isSingleCol && rows.length > 0) {
                  ...
                  const isDS = /Ciência de Dados|Conexão com a lógica|A ideia central|Exemplo narrado|Conclusão geral/i.test(headers[0]);
                  const calloutClass = isDS
                    ? "my-6 border-l-4 border-purple-400 bg-purple-100/50 rounded-r-lg px-5 py-4"
                    : "my-6 border-l-4 border-accent bg-accent/5 rounded-r-lg px-5 py-4";
                  return (
